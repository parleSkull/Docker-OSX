...
# RUN yes | sudo pacman -Syu bc qemu libvirt dnsmasq virt-manager bridge-utils openresolv extra/jack2 ebtables edk2-ovmf netctl libvirt-dbus wget --overwrite --noconfirm \
#     && yes | sudo pacman -Scc

RUN yes | sudo pacman -Sy extra/jack2

RUN yes | sudo pacman -Syu bc qemu libvirt dnsmasq virt-manager bridge-utils openresolv ebtables edk2-ovmf netctl libvirt-dbus wget --overwrite --noconfirm
